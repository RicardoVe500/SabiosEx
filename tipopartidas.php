...
<body id="page-top">
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php 
                            include('contenido/modal/tipopartidas/modaltipopartida.php');
                            include('contenido/modal/tipopartidas/editmodaltipopartida.php');

                            ?>
                            <a class="btn btn-success float-right" href="#" data-toggle="modal"
                                data-target="#inserttipopartida"><i class="fas fa-plus"></i> Crear</a>
    ...
    <script src="js/ajaxtipopartida.js"></script>
